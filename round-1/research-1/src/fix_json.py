...
data = {
    ...
    "sources": [
        ...
        },
        {
            ...
            "summary": "Carothers & Hartnett (2024) examine 12 backsliding cases and find inequality was DECREASING in 8 of 12 cases prior to backsliding. Argue backsliding stems from predatory leaders, not delivery failures."
        },
        {
            "index": 3,
            "url": "https://economics.mit.edu/sites/default/files/publications/de%20facto%20political%20power%20and%20institutional%20persist.pdf",
            "title": "De Facto Political Power and Institutional Persistence",
            "summary": "Acemoglu & Robinson (2006) AER paper establishing de jure vs. de facto political power framework. Elites offset de jure power losses by investing in de facto power, leading to institutional persistence."
        },
        {
            "index": 4,
            "url": "https://dukespace.lib.duke.edu/bitstreams/4661d68b-10c9-46d6-a174-dbaf238a6578/download",
            "title": "When does education increase political participation?",
            "summary": "Research finding education increases political participation primarily when democracy is threatened, supporting education as de facto political capacity mechanism."
        },
        {
            "index": 5,
            "url": "https://www.mitchellorenstein.com/s/Journal-of-Democracy-PDF.pdf",
            "title": "Poverty, Inequality, and Democracy: Postcommunist Welfare States",
            "summary": "Orenstein (2008) shows post-communist democracies with stronger welfare states maintained better social protection. Democracy → welfare effort, but flawed democracies and autocracies scored lower."
        },
        {
            "index": 6,
            "url": "https://www.journalofdemocracy.org/articles/the-anatomy-of-democratic-backsliding/",
            "title": "The Anatomy of Democratic Backsliding",
            "summary": "Haggard & Kaufman (2021) examine 16 backsliding cases, emphasizing polarization, legislative control, and incremental abuses. Welfare provision creates resilience by meeting fundamental needs."
        },
        {
            "index": 7,
            "url": "https://www.cambridge.org/core/journals/political-analysis/article/abs/understanding-interaction-models-improving-empirical-analyses/2n5qrgfneh593gw8bgfgj8mrj",
            "title": "Understanding Interaction Models: Improving Empirical Analyses",
            "summary": "Brambor, Clark & Golder (2006) foundational paper on interaction interpretation in political science. All lower-order terms must be included for identification."
        },
        {
            "index": 8,
            "url": "https://grantmcdermott.com/posts/interaction-effects/",
            "title": "Marginal effects and interaction terms",
            "summary": "Guidance on using marginaleffects package in R for interpreting three-way interactions. Recommends facet plots with welfare terciles."
        },
        {
            "index": 9,
            "url": "https://www.journalofdemocracy.org/articles/on-democratic-backsliding/",
            "title": "On Democratic Backsliding",
            "summary": "Bermeo (2016) classifies contemporary backsliding into promissory coups, executive aggrandizement, and strategic electoral manipulation. Inequality potentially facilitates all three."
        },
        {
            "index": 10,
            ...
            "summary": "Consensus that education positively correlates with political participation in consolidated democracies. Consistent with education as de facto power mechanism."
        },
        {
            "index": 11,
            "url": "https://www.v-dem.net/media/publications/UWP_54.pdf",
            "title": "Executive Aggrandizement and its Outcomes",
            "summary": "Laebens (2023) V-Dem working paper coding democratic erosion episodes using expert surveys. Provides binary erosion measure as alternative to continuous V-Dem index [11]."
        },
        {
            "index": 12,
            "url": "https://www.v-dem.net/static/website/img/refs/methodologyv111.pdf",
            "title": "V-Dem Methodology",
            "summary": "V-Dem measurement model documentation. Electoral Democracy Index correlates 0.95+ with Freedom House and Polity. Expert coders show high inter-coder reliability."
        },
        {
            "index": 13,
            "url": "https://ourworldindata.org/grapher/economic-inequality-gini-index",
            "title": "Income inequality: Gini coefficient - Our World in Data",
            "summary": "OWID data page documenting Gini coefficient sources (World Bank PIP), coverage (1963-2025, 180+ countries), and methodology (household surveys harmonized by World Bank)."
        },
        {
            "index": 14,
            "url": "https://www.statalist.org/forums/forum/general-stata-discussion/general/1750747-interpretation-of-three-way-interaction-and-margins",
            "title": "Interpretation of three-way interaction and margins",
            "summary": "Statalist discussion noting three-way interactions are substantially underpowered relative to constituent two-way interactions. Require ~8× sample size of main effect."
        },
        {
            "index": 15,
            "url": "https://www.cambridge.org/core/books/backsliding/CCD2F28FB63A56409FF8911351F2E937",
            "title": "Backsliding: Democratic Regress in the Contemporary World",
            "summary": "Haggard & Kaufman (2021) book examining how natural resource rents enable patronage and reduce accountability pressure, potentially confounding inequality-backsliding link."
        }
    ],
    "follow_up_questions": [
...
print("research_out.json successfully written with all required fields")
print(f"Title: {data['title']}")
print(f"Summary length: {len(data['summary'])} chars")
print(f"Answer length: {len(data['answer'])} chars")
print(f"Sources: {len(data['sources'])} (indices 1-{len(data['sources'])})")
