...
- **1. create_idea** — `hypo_loop`
  - round_1
    ...
    - `prompts/1_create_idea/round_1/2_review_hypo.md` — 5 prompt(s)
- **2. test_idea** — `invention_loop`
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_dataset_1.md` — 5 prompt(s)
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 5 task(s)
    ...
    - `prompts/3_report_results/1_gen_viz/gen_viz_3.md` — 4 prompt(s)
